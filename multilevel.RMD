...
The following code shows an example for a multilevel-pca analysis.
Multilevel pca focusses on within-subject variance rather than interindividual.
It is primarily used for visualization.
